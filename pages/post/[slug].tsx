...
const Post = ({ post }: Props) => {
  ...
  return (
    <main className="max-w-7xl mx-auto">
        ...
        <article className="max-w-3-xl mx-auto p-5">
        ...
        {/* Comments */}
        <div className="flex flex-col p-10 my-10 max-w-2xl mx-auto space-y-2 shadow-yellow-500 shadow">
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    const query = `*[_type == "post" && slug.current == $slug][0]{
      ...
      return {
          ...
          revalidate: 3600, //after 3600 seconds, it will update the old cached version
      }
}